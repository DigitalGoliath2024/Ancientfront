...
const CARD_PILL_CLASS =
  "font-map inline-block px-2 py-1 rounded text-xs font-bold tracking-widest bg-malibu-blue text-white";
  ...
  return html`
    ...
    >
      ...
      >
        ...
        <span
          class="absolute bottom-full right-2 mb-1 flex items-center gap-1 font-map text-xs font-bold tracking-widest bg-black/70 backdrop-blur-sm px-2 py-0.5 rounded"
        >
          ${playerCount}
          <svg
