    ...
    return html`
      ...
      >
        <div class="mb-2 flex items-center gap-2">
          ...
          <span
            class="ml-auto text-[11px] text-white/55"
            title="${count}"
            aria-label="${count}"
            >${count}</span
          >
  ...
  private renderCard(s: LiveStream) {
    return html`
      ...
      >
        ...
        <div
          class="w-full truncate text-[11px] font-medium text-white transition-colors group-hover:text-white/70"
        >
          ${s.displayName}
        </div>
        <div class="w-full truncate text-[10px] text-white/55">
