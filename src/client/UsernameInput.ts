...
const NAME_TEXT =
  "text-xl/[normal] sm:text-2xl/[normal] font-medium tracking-wider text-white";
...
export class UsernameInput extends LitElement {
  ...
  private renderClanControl() {
    ...
    return html`
      ...
      <div
        class="no-crazygames relative shrink-0 h-10"
        ...
        >
          ...
          ${this.clanCheckPending
            ...
            : html`<svg
                viewBox="0 0 20 20"
                fill="currentColor"
                class="w-3 h-3 shrink-0 text-white/50"
                aria-hidden="true"
              >
                <path
    ...
    return html`
      ...
      >
        ${clans.length > 0
          ? html`
              <div
                class="px-2 pt-1 pb-1.5 text-[11px] font-bold uppercase tracking-wider text-white/45"
              >
        ...
        <div class="mt-1.5 border-t border-white/10 pt-1.5">
          <label
            class="block px-2 pb-1 text-[11px] font-bold uppercase tracking-wider text-white/45"
            for="clan-tag-manual"
          ...
          <input
            ...
            class="w-full rounded-lg border border-white/20 !bg-black/40 px-2 py-1.5 text-base font-semibold uppercase tracking-wider !text-white placeholder-white/35 focus:border-malibu-blue/60 focus:outline-none"
          />
        </div>
        <div
        ...
        >
          ${this.clanTag
            ? html`<button
                type="button"
                class="rounded-lg px-2 py-1 text-sm text-white/70 hover:bg-white/10 hover:text-white transition-colors cursor-pointer"
  ...
  private renderVerifiedChip() {
    return html`
      ...
      >
        ...
        <span class="min-w-0 truncate ${NAME_TEXT}"
  ...
  private renderNameInput() {
    return html`
      <input
        ...
        class="text-left !text-white placeholder-white/40 !bg-transparent transition-colors text-ellipsis hover:bg-white/5 focus:bg-white/5 focus:outline-none focus:ring-2 focus:ring-malibu-blue/60 ${NAME_BOX} ${NAME_TEXT}"
      />
    `;
  }
