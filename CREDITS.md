...
**Marauder's Sea** is a fork of [OpenFront.io](https://github.com/openfrontio/OpenFrontIO), which is itself a fork/rewrite of [WarFront.io](https://github.com/WarFrontIO).
